...
public class AddStudentDialog extends javax.swing.JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Personal information", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("ID card/passport number: ");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student information", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
    ...
    private void addNewStudent() {
        ...
        if (pId.isEmpty() || fullName.isEmpty() || dobStr.isEmpty()
            ...
            var msg = "Please fill in student information completely!";
            showMessage(msg);
        } else {
            try {
                ...
                if (students.contains(student)) {
                    var msg = "Student \"" + studentId + "\" existed!";
                    showMessage(msg);
                } else {
                    homeFrm.addStudentCallback(student);
                    var msg = "New student added successfully!";
                    showMessage(msg);
                }
            } catch (InvalidStudentIdException ex) {
                var msg = "Valid Student ID example: B25DCCN125";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidPersonIdException ex) {
                var msg = "Valid ID example: A2021123123";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidEmailException ex) {
                var msg = "Valid email example: example@gmail.com";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidPhoneNumberException ex) {
                var msg = "Valid phone number example: 0988123123";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidNameException ex) {
                var msg = "Full name must contain only letters and spaces.";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidDateOfBirthException ex) {
                var msg = "Valid date of birth example: 22/11/2005";
                showMessage(ex.getMessage() + "\n" + msg);
            }
        }
    }
