...
public class EditStudentDialog extends javax.swing.JDialog implements ActionListener {
    ...
    private void editStudent() {
        ...
        if (pId.isEmpty() || fullName.isEmpty() || dobStr.isEmpty()
            ...
            try {
                    ...
                    var msg = "Student information updated successfully!";
                    showMessage(msg);
                    dispose();
            } catch (InvalidEmailException ex) {
                var msg = "Valid email: example@gmail.com";
                showMessage(ex.getMessage() + "\n" + msg);
            } catch (InvalidPhoneNumberException ex) {
                var msg = "Valid phone number: 0988123123";
                showMessage(ex.getMessage() + "\n" + msg);
    ...
    private void setData() {
        ...
        // Set up each student's respective major choices
