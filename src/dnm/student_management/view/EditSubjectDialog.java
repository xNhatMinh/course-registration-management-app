...
public class EditSubjectDialog extends javax.swing.JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Number of lessons");
        ...
        comboSubjectType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "General", "Basis of the major", "Compulsory majors", "Elective majors", "Alternative subjects" }));
    ...
    private void editSubject() {
        ...
        if (!name.isEmpty() && !numOfLessonString.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Successfully updated course!");
            dispose();
        } else {
